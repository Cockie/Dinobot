...
class Server:
    ...
    def connect(self):
        ...
        self.ircsock.send(bytes(
            "USER " + self.nick + " " + self.nick + " " + self.nick + " :This is a result of a tutorial covered on http://shellium.org/wiki.\n",
        ...
        while 1:  # Be careful with these! it might send you to an infinite loop
            ...
            if mess.find("Found your hostname") != -1 or mess.find("No ident response") != -1:
                sent = "NICK " + self.nick + "\n" + "USER " + self.nick + " " + self.nick + " " + self.nick + " :This is a result of a tutoral covered on http://shellium.org/wiki.\n"
    ...
    def pm(self, name, msg):  # This is the send message function, it simply sends messages to the channel.
        msg = msg.split('\n')
        for line in msg:
            self.ircsock.send(bytes("PRIVMSG " + name + " :" + line + "\n", 'UTF-8'))
